...
public class RegistryReportsDeregistrationStatus implements Event { 
	...
	public RegistryReportsDeregistrationStatus(byte[] message) { // constructor for decoding byte message
	...
	public byte[] getBytes() throws IOException { // getBytes method for creating a byte array to send
		...
		dout.writeByte(Protocol.REGISTRY_REPORTS_DEREGISTRATION_STATUS);
